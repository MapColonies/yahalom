...
namespace com.mapcolonies.yahalom.DataManagement.AppSettings
{
    ...
    {
        private const string SettingsFileName = "DataManagement/app_settings.json";
        ...
        {
            AppSettingsState appState = await JsonUtilityEx.LoadJsonAsync<AppSettingsState>(SettingsFileName);
