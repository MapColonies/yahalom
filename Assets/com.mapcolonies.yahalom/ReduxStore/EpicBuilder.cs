...
namespace com.mapcolonies.yahalom.ReduxStore
{
    public ref struct EpicBuilder<TState>
    {
        ...
        public void Add(Epic<TState> epic)
        {
            ...
            {
                Epic<TState>[] newEpics = ArrayPool<Epic<TState>>.Shared.Rent(_count * 2);
    ...
    public ref struct EpicBuilder<TState, TDependencies>
    {
        ...
        public void Add(Epic<TState, TDependencies> epic)
        {
            ...
            {
                Epic<TState, TDependencies>[] newEpics = ArrayPool<Epic<TState, TDependencies>>.Shared.Rent(_count * 2);
                Array.Copy(_epics, newEpics, _count);
